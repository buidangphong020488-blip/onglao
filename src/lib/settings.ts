...
const DEFAULT_SETTINGS: SystemSettings = {
  ...
  laoVoiceStyle: 'Giọng ấm áp, mạnh mẽ, dứt khoát, miền nam việt nam, đúng chính tả, ngắt nhịp rõ ràng giữa các câu',
  userVoiceName: 'Kore',
  userVoiceStyle: 'giọng thanh niên, phong cách đọc tỏ vẻ rối rắm, thắc mắc, chuẩn giọng miền Nam Việt Nam, đúng chính tả',
  momoPhone: '',
  momoName: '',
  bankName: '',
  bankAccount: '',
